<div style="margin-left: auto;
    margin-right: auto; width: 45%"class="ui fluid search selection dropdown">
  <input type="hidden" name="country">
  <i class="dropdown icon"></i>
  <div class="default text">Country Code</div>
  <div class="menu">
  <div class="item" data-value="gb"><i class="gb flag"></i>UK --> (0044)</div>
  <div class="item" data-value="pl"><i class="pl flag"></i>Poland --> (0044)</div>
  <div class="item" data-value="us"><i class="us flag"></i>United States --> (001)</div>
  <div class="item" data-value="es"><i class="es flag"></i>Spain --> (0034)</div>
  <div class="item" data-value="fr"><i class="fr flag"></i>France --> (0033) </div>
